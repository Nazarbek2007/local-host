const Button = document.querySelector('.header__content-icons'),
    img1 = document.querySelector('.header__content-span'),
    test = document.querySelector('.header__content-test.active2');
Button.addEventListener('click', (e) => {
    e.preventDefault()
    Button.classList.toggle('active')
    test.classList.toggle('active2')
})
